...
public class MediaPlayerIosOptions: NSObject {
    ...
    init(enableExternalPlayback: Bool?, enablePiP: Bool?, enableBackgroundPlay: Bool?, openInFullscreen: Bool?, automaticallyEnterPiP: Bool?, top: Float?, left: Float?, height: Float?, width: Float?, fullscreenOnLandscape: Bool?){
