...
public class AndroidOptions {
    ...
    public AndroidOptions(Boolean enableChromecast, Boolean enablePiP, Boolean enableBackgroundPlay, Boolean openInFullscreen, Boolean automaticallyEnterPiP, Double top, Double left, Double height, Double width) {
